    ...
    <Sonner
      ...
      toastOptions={{
        classNames: {
          ...
          title:
            "group-[.toast]:font-sans group-[.toast]:text-xs group-[.toast]:font-medium group-[.toast]:text-foreground",
          description:
            "group-[.toast]:text-muted-foreground group-[.toast]:text-xs group-[.toast]:font-normal group-[.toast]:font-sans",
          actionButton:
          ...
          success:
            "group-[.toaster]:border-border group-[.toaster]:bg-background group-[.toaster]:text-foreground",
          error:
            "group-[.toaster]:border-destructive/50 group-[.toaster]:bg-background group-[.toaster]:text-foreground",
          warning:
            "group-[.toaster]:border-amber-500/40 group-[.toaster]:bg-background group-[.toaster]:text-foreground",
          info: "group-[.toaster]:border-border group-[.toaster]:bg-background group-[.toaster]:text-foreground",
        },
      }}
      icons={{
        success: (
          <Info className="h-3.5 w-3.5 text-emerald-600 dark:text-emerald-400 shrink-0 stroke-[2.2]" />
        ),
        error: (
          <Info className="h-3.5 w-3.5 text-destructive dark:text-red-400 shrink-0 stroke-[2.2]" />
        ),
        warning: (
          <Info className="h-3.5 w-3.5 text-amber-600 dark:text-amber-400 shrink-0 stroke-[2.2]" />
        ),
