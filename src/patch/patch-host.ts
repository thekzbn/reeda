...
import type { ReedaPluginManifest, ReedaSlotId, PluginLifecycleStatus } from "./types";
...
const DEFAULT_PLUGINS: ReedaPluginManifest[] = [
  {
    ...
    description:
      "Calculates estimated minutes remaining based on current page progress and average reading pace.",
    category: "reader",
    author: "Reeda Lab",
    version: "1.2.0",
    enabled: true,
  ...
  },
  {
    ...
    description:
      "Generates formatted APA, BibTeX, Chicago, and MLA citation blocks directly into your notes.",
    category: "notes",
    author: "Reeda Lab",
    version: "1.1.0",
    enabled: false,
  ...
  },
  {
    ...
    description:
      "Categorize and filter your library documents by reading status (To Read, In Progress, Synthesized).",
    category: "library",
    author: "Reeda Lab",
    version: "1.0.0",
    enabled: false,
  ...
  },
  {
    ...
    name: "Publish & Report",
    description:
      "Insert structured note templates (Cornell, Executive Summary, Lit Review, Q&A) and export notes to HTML, Markdown, or PDF with document metadata.",
    category: "notes",
    author: "Reeda Lab",
    version: "1.0.0",
    enabled: false,
